    ...
    <section className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-20 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="max-w-md w-full bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 space-y-8">
        <div className="text-center">
          <h1 className="text-4xl md:text-3xl font-bold bg-gradient-to-r from-[#25789e] to-gray-800 bg-clip-text text-transparent mb-4 font-raleway">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-[#25789e]/50 focus:border-[#25789e] transition-all duration-300 shadow-sm font-raleway"
                required
              />
            </div>
            <div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              className="w-full px-4 py-3 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-[#25789e]/50 focus:border-[#25789e] transition-all duration-300 shadow-sm font-raleway mb-4"
              required
            />
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600 font-raleway">
            ...
            <a
              href="/login"
              className="font-semibold text-[#25789e] hover:text-[#1e3a40] transition-colors font-raleway"
            >
              Sign in
            </a>
          </p>
